...
%%
readin		: readin declaration ';'{ printf("Line %d:%s ;\n",lineno++,$2); }
			| readin method_declr { printf("Line %d:%s\n",lineno++,$2); }
			| readin class_declr { printf("Line %d:%s\n",lineno++,$2); }
			| readin new_obj { printf("Line %d:%s ;\n",lineno++,$2); }
			| readin simple { printf("Line %d:%s\n",lineno++,$2); }
			| readin conditional { printf("Line %d:%s\n",lineno++,$2); }
			| readin boolean_expr ';' { printf("Line %d:%s ;\n",lineno++,$2); }
			| readin loop { printf("Line %d:%s\n",lineno++,$2); }
