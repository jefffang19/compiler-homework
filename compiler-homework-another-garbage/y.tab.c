...
#define IDLEN 100
#define STACKSIZE 50
#define LINEOFPROGRAM 1000

static int lineno = 1;
int line[LINEOFPROGRAM] = {0};
...
static const yytype_uint16 yyrline[] =
{
      ...
      57,    58,    60,    64,    68,    73,    82,    89,    93,    96,
     100,   105,   114,   123,   132,   141,   151,   161,   171,   181,
     189,   197,   205,   214,   218,   222,   226,   231,   232,   233,
     235,   240,   248,   256,   264,   268,   276,   284,   292,   301,
     302,   307,   311,   315,   319,   323,   327,   331,   335,   340,
     341,   345,   347,   348,   349,   350,   351,   352,   354,   358,
     362,   366,   370,   374,   379,   383,   387,   391,   395,   399,
     403,   407,   412,   413,   414,   418,   423,   424,   428,   432,
     437,   437,   437,   437,   437,   437,   439,   443,   447,   451,
     455,   459,   463,   465,   466,   470,   474,   478,   483,   494,
     502,   510,   518,   519,   525,   526,   530,   534,   536,   537,
     541,   547,   552,   553,   557,   558,   559,   563,   566,   569,
     571,   579,   587,   595,   603,   607,   612,   620,   630,   634,
     639,   643,   644,   645,   649,   653,   657,   662,   666,   671,
     672,   677,   681,   685,   687,   692
};
#endif
...
#line 73 "test.y" /* yacc.c:1646  */
    {
				...
				if(check_sameid((yyvsp[-3].s))) sprintf((yyval.s),"%s %s {\n>'%s' is a duplicate identifier\nLine %d:%s\nLine %d:}",(yyvsp[-4].s),(yyvsp[-3].s),(yyvsp[-3].s),lineno++,(yyvsp[-1].s),lineno++);
				else{ 
					add_id((yyvsp[-3].s));
					sprintf((yyval.s),"%s %s {\nLine %d:%s\nLine %d:}",(yyvsp[-4].s),(yyvsp[-3].s),lineno++,(yyvsp[-1].s),lineno++);
				}
			}
...
#line 96 "test.y" /* yacc.c:1646  */
    {
				(yyval.s) = (char*)malloc(sizeof(char)*15*returnDollarLEN);	
				sprintf((yyval.s),"%s ;\nLine %d:%s",(yyvsp[-2].s),lineno++,(yyvsp[0].s));
			}
...
#line 100 "test.y" /* yacc.c:1646  */
    {
				(yyval.s) = (char*)malloc(sizeof(char)*15*returnDollarLEN);	
				sprintf((yyval.s),"%s\nLine %d:%s",(yyvsp[-1].s),lineno++,(yyvsp[0].s));
			}
...
#line 105 "test.y" /* yacc.c:1646  */
    { /*function*/
				...
				if(check_sameid((yyvsp[-6].s))) sprintf((yyval.s),"%s %s(%s){\n>'%s' is a duplicate identifier\n%s\n}",(yyvsp[-7].s),(yyvsp[-6].s),(yyvsp[-4].s),(yyvsp[-6].s),(yyvsp[-1].s));
					...
					add_id((yyvsp[-6].s));
					sprintf((yyval.s),"%s %s(%s){\nLine %d:%s\nLine %d:}",(yyvsp[-7].s),(yyvsp[-6].s),(yyvsp[-4].s),lineno++,(yyvsp[-1].s),lineno++);
				}
			}
...
#line 114 "test.y" /* yacc.c:1646  */
    { /*function*/
				/* ps compound is things inside function(){ HERE } */
				(yyval.s) = (char*)malloc(sizeof(char)*15*returnDollarLEN);
				if(check_sameid((yyvsp[-6].s))) sprintf((yyval.s),"%s %s %s(%s){\n>'%s' is a duplicate identifier\nLine %d:%s\nLine %d:}",(yyvsp[-8].s),(yyvsp[-7].s),(yyvsp[-6].s),(yyvsp[-4].s),(yyvsp[-6].s),lineno++,(yyvsp[-1].s),lineno++);
				else{
					add_id((yyvsp[-6].s));
					sprintf((yyval.s),"%s %s %s(%s){\nLine %d:%s\nLine %d:}",(yyvsp[-8].s),(yyvsp[-7].s),(yyvsp[-6].s),(yyvsp[-4].s),lineno++,(yyvsp[-1].s),lineno++);
				}
			}
...
#line 123 "test.y" /* yacc.c:1646  */
    { /*function*/
				...
				if(check_sameid((yyvsp[-5].s))) sem_def = 1;
					...
					add_id((yyvsp[-5].s));
					sprintf((yyval.s),"%s %s(){\nLine %d:%s\nLine %d:}",(yyvsp[-6].s),(yyvsp[-5].s),lineno++,(yyvsp[-1].s),lineno++);
				}
			}
...
#line 132 "test.y" /* yacc.c:1646  */
    { /*function*/
				/* ps compound is things inside function(){ HERE } */
				(yyval.s) = (char*)malloc(sizeof(char)*15*returnDollarLEN);
				if(check_sameid((yyvsp[-5].s))) sprintf((yyval.s),"%s %s %s(){\n>'%s' is a duplicate identifier\nLine %d:%s\nLine %d:}",(yyvsp[-7].s),(yyvsp[-6].s),(yyvsp[-5].s),(yyvsp[-5].s),lineno++,(yyvsp[-1].s),lineno++);
				else{ 
					sprintf((yyval.s),"%s %s %s(){\nLine %d:%s\nLine %d:}",(yyvsp[-7].s),(yyvsp[-6].s),(yyvsp[-5].s),lineno++,(yyvsp[-1].s),lineno++);
 					add_id((yyvsp[-5].s));
 				}
			}
...
#line 311 "test.y" /* yacc.c:1646  */
    {
					...
					sprintf((yyval.s),"%s(%s) {\nLine %d:%s\nLine %d:}",(yyvsp[-6].s),(yyvsp[-4].s),lineno++,(yyvsp[-1].s),lineno++);
				}
...
#line 315 "test.y" /* yacc.c:1646  */
    {
					(yyval.s) = (char*)malloc(sizeof(char)*2*returnDollarLEN);					
					sprintf((yyval.s),"%s(%s) %s\nLine %d:%s %s",(yyvsp[-6].s),(yyvsp[-4].s),(yyvsp[-2].s),lineno++,(yyvsp[-1].s),(yyvsp[0].s));
				}
...
#line 319 "test.y" /* yacc.c:1646  */
    {
					...
					sprintf((yyval.s),"%s(%s) %s\n%s {\nLine %d:%s\nLine %d:}",(yyvsp[-8].s),(yyvsp[-6].s),(yyvsp[-4].s),(yyvsp[-3].s),lineno++,(yyvsp[-1].s),lineno++);
				}
#line 2203 "y.tab.c" /* yacc.c:1646  */
    break;

  case 55:
#line 323 "test.y" /* yacc.c:1646  */
    {
					(yyval.s) = (char*)malloc(sizeof(char)*10*returnDollarLEN);					
					sprintf((yyval.s),"%s(%s) {\nLine %d:%s\nLine %d:}\nLine %d:%s %s",(yyvsp[-8].s),(yyvsp[-6].s),lineno++,(yyvsp[-3].s),lineno++,lineno++,(yyvsp[-1].s),(yyvsp[0].s));
				}
...
#line 327 "test.y" /* yacc.c:1646  */
    {
					(yyval.s) = (char*)malloc(sizeof(char)*15*returnDollarLEN);					
					sprintf((yyval.s),"%s(%s) {\nLine %d:%s\nLine %d:}\nLine %d:%s {\nLine %d:%s\nLine %d:}",(yyvsp[-10].s),(yyvsp[-8].s),lineno++,(yyvsp[-5].s),lineno++,lineno++,(yyvsp[-3].s),lineno++,(yyvsp[-1].s),lineno++);
				}
...
#line 366 "test.y" /* yacc.c:1646  */
    {
					(yyval.s) = (char*)malloc(sizeof(char)*10*returnDollarLEN);
					sprintf((yyval.s),"%s ( ) {\nLine %d:%s\nLine %d:}",(yyvsp[-5].s),lineno++,(yyvsp[-1].s),lineno++);
			}
...
#line 2693 "y.tab.c" /* yacc.c:1646  */
  ...
  case 114:
#line 525 "test.y" /* yacc.c:1646  */
    { (yyval.s) = (yyvsp[0].s);}
#line 2699 "y.tab.c" /* yacc.c:1646  */
    break;

  case 115:
#line 526 "test.y" /* yacc.c:1646  */
    {
					(yyval.s) = (char*)malloc(sizeof(char)*returnDollarLEN);
					sprintf((yyval.s),"%s + %s",(yyvsp[-2].s),(yyvsp[0].s));
				}
